...
public class DriveSpecialForces extends HomeApplication implements Initializable {

    @FXML
    private ListView<String> filePane;

    @FXML
    private Button conops, doctrine, classes, ranges, other, language, russian;
    ...
    private void setupButtonActions() {
        conops.setOnAction(event -> {
            try {
                fetchAndDisplayFiles("Special-Forces", "CONOPS");
        ...
        doctrine.setOnAction(event -> {
            try {
                fetchAndDisplayFiles("Special-Forces", "Doctrine");
            } catch (JSONException e) {
                throw new RuntimeException(e);
            }
        });
        classes.setOnAction(event -> {
            try {
                fetchAndDisplayFiles("Special-Forces", "Classes");
            } catch (JSONException e) {
                throw new RuntimeException(e);
            }
        });
        ranges.setOnAction(event -> {
            try {
                fetchAndDisplayFiles("Special-Forces", "Ranges");
            } catch (JSONException e) {
                throw new RuntimeException(e);
            }
        });
        russian.setOnAction(event -> {
            try {
                fetchAndDisplayFiles("Special-Forces", "Language-Russian");
            } catch (JSONException e) {
                throw new RuntimeException(e);
            }
        });
        language.setOnAction(event -> {
            try {
                fetchAndDisplayFiles("Special-Forces", "Language");
            } catch (JSONException e) {
                throw new RuntimeException(e);
            }
        });
        other.setOnAction(event -> {
            try {
                fetchAndDisplayFiles("Special-Forces", "Other");
            } catch (JSONException e) {
                throw new RuntimeException(e);
            }
        });
