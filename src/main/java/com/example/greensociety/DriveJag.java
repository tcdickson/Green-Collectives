...
public class DriveJag extends HomeApplication implements Initializable {
    ...
    private void setupButtonActions() {
        conops.setOnAction(event -> {
            try {
                fetchAndDisplayFiles("JAG", "CONOPS");
        ...
        doctrine.setOnAction(event -> {
            try {
                fetchAndDisplayFiles("JAG", "Doctrine");
            } catch (JSONException e) {
                throw new RuntimeException(e);
            }
        });
        classes.setOnAction(event -> {
            try {
                fetchAndDisplayFiles("JAG", "Classes");
            } catch (JSONException e) {
                throw new RuntimeException(e);
            }
        });
        ranges.setOnAction(event -> {
            try {
                fetchAndDisplayFiles("JAG", "Ranges");
            } catch (JSONException e) {
                throw new RuntimeException(e);
            }
        });
        other.setOnAction(event -> {
            try {
                fetchAndDisplayFiles("JAG", "Other");
            } catch (JSONException e) {
                throw new RuntimeException(e);
            }
        });
    ...
    private void fetchAndDisplayFiles(String folder, String category) throws JSONException {
        ...
        private void downloadFile (String folder, String category, String filename){
            ...
            if (downloadUrl != null) {
                ...
                // You can also show a user-friendly alert/message here
