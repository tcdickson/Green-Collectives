...
public class DriveSignal extends HomeApplication implements Initializable {
    ...
    private void setupButtonActions() {
        conops.setOnAction(event -> {
            try {
                fetchAndDisplayFiles("Signal", "CONOPS");
        ...
        doctrine.setOnAction(event -> {
            try {
                fetchAndDisplayFiles("Signal", "Doctrine");
            } catch (JSONException e) {
                throw new RuntimeException(e);
            }
        });
        classes.setOnAction(event -> {
            try {
                fetchAndDisplayFiles("Signal", "Classes");
            } catch (JSONException e) {
                throw new RuntimeException(e);
            }
        });
        ranges.setOnAction(event -> {
            try {
                fetchAndDisplayFiles("Signal", "Ranges");
            } catch (JSONException e) {
                throw new RuntimeException(e);
            }
        });
        other.setOnAction(event -> {
            try {
                fetchAndDisplayFiles("Signal", "Other");
            } catch (JSONException e) {
                throw new RuntimeException(e);
            }
        });
