...
public class DriveFieldArtillery extends HomeApplication implements Initializable {
    ...
    private void setupButtonActions() {
        conops.setOnAction(event -> {
            try {
                fetchAndDisplayFiles("Field-Artillery", "CONOPS");
        ...
        doctrine.setOnAction(event -> {
            try {
                fetchAndDisplayFiles("Field-Artillery", "Doctrine");
            } catch (JSONException e) {
                throw new RuntimeException(e);
            }
        });
        classes.setOnAction(event -> {
            try {
                fetchAndDisplayFiles("Field-Artillery", "Classes");
            } catch (JSONException e) {
                throw new RuntimeException(e);
            }
        });
        ranges.setOnAction(event -> {
            try {
                fetchAndDisplayFiles("Field-Artillery", "Ranges");
            } catch (JSONException e) {
                throw new RuntimeException(e);
            }
        });
        other.setOnAction(event -> {
            try {
                fetchAndDisplayFiles("Field-Artillery", "Other");
            } catch (JSONException e) {
                throw new RuntimeException(e);
            }
        });
