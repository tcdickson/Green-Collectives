...
public class DriveFinance extends HomeApplication implements Initializable {
    ...
    private void setupButtonActions() {
        conops.setOnAction(event -> {
            try {
                fetchAndDisplayFiles("Finance", "CONOPS");
        ...
        doctrine.setOnAction(event -> {
            try {
                fetchAndDisplayFiles("Finance", "Doctrine");
            } catch (JSONException e) {
                throw new RuntimeException(e);
            }
        });
        classes.setOnAction(event -> {
            try {
                fetchAndDisplayFiles("Finance", "Classes");
            } catch (JSONException e) {
                throw new RuntimeException(e);
            }
        });
        ranges.setOnAction(event -> {
            try {
                fetchAndDisplayFiles("Finance", "Ranges");
            } catch (JSONException e) {
                throw new RuntimeException(e);
            }
        });
        other.setOnAction(event -> {
            try {
                fetchAndDisplayFiles("Finance", "Other");
            } catch (JSONException e) {
                throw new RuntimeException(e);
            }
        });
